...
from ..forms.employeeAssign import EmployeeAssignForm
from ... import db
...
def add_department():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            db.session.commit()
            flash('You have succesfully added a new department')
        except:
...
def edit_department(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('You successfully edited the department')
        return redirect(url_for('admin.list_departments'))
